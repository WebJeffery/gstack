...
> ```bash
> git clone https://github.com/WebJeffery/gstack.git.git ~/.claude/skills/gstack
> ```
...
```bash
git clone --single-branch --depth 1 https://github.com/WebJeffery/gstack.git.git .agents/skills/gstack
...
```bash
git clone --single-branch --depth 1 https://github.com/WebJeffery/gstack.git.git ~/gstack
