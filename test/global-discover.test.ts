...
describe("gstack-global-discover", () => {
  describe("normalizeRemoteUrl", () => {
    ...
    test("SSH and HTTPS for same repo normalize to same URL", () => {
      ...
      const https = normalizeRemoteUrl("https://github.com/WebJeffery/gstack.git.git");
      const httpsNoDotGit = normalizeRemoteUrl("https://github.com/WebJeffery/gstack.git");
