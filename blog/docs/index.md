---
layout: home
title: OpenClaw + GStack 中文文档 | 安装教程 · 源码剖析 · AI 工程工作流
description: OpenClaw 中文完整文档（276+ 篇）与 GStack AI 工程技能库导读同站：多通道智能体框架 + 斜杠工作流（评审/QA/发版）。安装部署、Gateway、通道适配器、源码剖析；GStack 安装与技能一览见 GStack 专栏。
head:
  - - meta
    - name: keywords
      content: OpenClaw, ClawdBot, GStack, garrytan, AI智能体, AI Agent, 多通道机器人, WhatsApp机器人, Telegram机器人, Discord机器人, Slack机器人, 飞书机器人, Claude Code, SKILL, 工作流, 通道适配器, Gateway, Ollama, DeepSeek, 源码剖析, 开源AI框架
hero:
  name: OpenClaw + GStack 文档库
  text: OpenClaw 工程拆解与 GStack AI 工作流技能，同一站点查阅
  tagline: OpenClaw：智能体主链、通道与 Gateway；GStack：/review、/qa、/ship 等结构化技能。安装教程与源码剖析全覆盖，并附 GStack 中文导读。
  actions:
    - theme: brand
      text: 安装教程
      link: /tutorials/
...
<a href="/gstack/" class="oc-module oc-module--gstack">
<div class="oc-module-icon">
...
<div class="oc-module-body">
<span class="oc-module-num">GS</span>
<h3>GStack 专栏</h3>
<p>AI 工程工作流技能库：斜杠命令覆盖评审、无头浏览器 QA、发版与文档。与 OpenClaw 互补——框架连通道，技能管仓库内交付节奏。</p>
</div>
<span class="oc-module-arrow">&rarr;</span>
</a>
...
<div class="oc-metric"><span class="oc-metric-val">3+1</span><span class="oc-metric-key">主线 · GStack</span></div>
<div class="oc-metric-sep"></div>
...
<article class="oc-home-entry oc-home-entry--gstack">
<h3>GStack</h3>
<p class="oc-home-entry-title">AI 工程工作流技能</p>
<p>在 Claude Code 等环境中使用结构化技能：从 /office-hours 到 /ship，配合 /browse 做真实浏览器验证。本专栏提供中文导读与安装说明。</p>
<a href="/gstack/">进入 GStack 专栏 &rarr;</a>
</article>
</section>
